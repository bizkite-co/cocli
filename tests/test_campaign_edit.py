...
def test_campaign_edit_with_editor_configured(setup_test_campaign):
    ...
    with patch('cocli.commands.campaign.get_editor_command', return_value=editor_cmd) as mock_get_editor_command, \
...
def test_campaign_edit_no_editor_configured(setup_test_campaign):
    ...
    with patch('cocli.commands.campaign.get_editor_command', return_value=None) as mock_get_editor_command, \
