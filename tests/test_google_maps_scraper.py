...
# @pytest.fixture # Temporarily comment out the fixture
# def mock_playwright():
...
def test_scrape_google_maps_returns_data(mock_get_coordinates): # Removed mock_playwright
    """
    ...
    """
    # mock_page, mock_locator = mock_playwright # Removed this line
    zip_code = "90210"
