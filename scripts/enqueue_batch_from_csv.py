...
@app.command()
def main(
    csv_input: Optional[Path] = typer.Argument(None, help="Path to input CSV file. Defaults to campaign exports."),
    ...
    if csv_input is None:
        ...
        csv_input = exports_dir / "prospects_missing_emails.csv"
    ...
    output_path = get_temp_dir() / f"enqueued_{tag}.json"
