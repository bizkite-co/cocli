...
class ScrapeSQSQueue:
    """
    AWS SQS based queue implementation for ScrapeTasks.
    """
    ...
    def push(self, message: ScrapeTask) -> str:
    ...
    def ack(self, message: ScrapeTask) -> None:
        """
    ...
    def nack(self, message: ScrapeTask) -> None:
        """
