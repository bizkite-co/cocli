...
class GoogleMapsGoldenItem(BaseIndexModel):
    ...
    @classmethod
    def save_datapackage(cls, path: Path, resource_name: str = "google_maps_golden", resource_path: str = "golden_set.usv", force: bool = False, wasi_hash: Optional[str] = None) -> None:
